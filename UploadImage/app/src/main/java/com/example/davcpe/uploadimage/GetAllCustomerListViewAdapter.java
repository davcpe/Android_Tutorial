package com.example.davcpe.uploadimage;
...
public class GetAllCustomerListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try
        {
            ...
            {
                cell.mobile.setImageResource(R.drawable.food_icon);
            }
            else if (mobile.equals("Android"))
            {
                cell.mobile.setImageResource(R.drawable.sleep_icon2);
            }
            else if (mobile.equals("Nokia"))
            {
                cell.mobile.setImageResource(R.drawable.walk_icon);
            }
            else
            {
            }
